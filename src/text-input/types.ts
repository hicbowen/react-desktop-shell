...
export interface AppTextAreaProps extends TextareaHTMLAttributes<HTMLTextAreaElement> { invalid?: boolean; resize?: 'none' | 'vertical' | 'both'; autoResize?: boolean; minRows?: number; maxRows?: number; showCount?: boolean; fullWidth?: boolean }
