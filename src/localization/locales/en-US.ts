...
export const enUSMessages = {
  ...
  dataTable: {
    ...
    selectAllOptions: "Select all matching options",
    ...
    columnActions: (columnId: string) => `${columnId} column actions`,
    sortAscending: "Sort ascending",
    sortDescending: "Sort descending",
    clearSorting: "Clear sorting",
    clearColumnFilter: "Clear column filter",
    stickyColumn: (columnId: string) => `${columnId} column is sticky`,
    pinnedColumn: (columnId: string) => `${columnId} column is pinned`,
  },
  pagination: {
    label: "Pagination",
