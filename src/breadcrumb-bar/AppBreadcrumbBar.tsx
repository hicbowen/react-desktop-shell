    ...
    <ol className="app-breadcrumb-bar__list">
      ...
      {visible.map((item, index) => {
        ...
        return <li className="app-breadcrumb-bar__part" key={item.key}>
          ...
          {!current ? <span className="app-breadcrumb-bar__separator"><ChevronRight16Regular aria-hidden="true" focusable="false" /></span> : null}
        </li>
      })}
    </ol>
  </nav>
