...
export function AppBreadcrumbBar({ ariaLabel = 'Breadcrumb', className, items, maxVisibleItems = 5, onItemSelect, overflowLabel = 'Show earlier locations', style }: AppBreadcrumbBarProps) {
