...
export function ButtonsPage() {
  ...
  return <DemoPage>
    ...
    <DemoSection title="States and icons"><DemoPreview className="demo-component-row"><AppButton icon={<Send />}>{t('Before')}</AppButton><AppButton icon={<Send />} iconPosition="end">{t('After')}</AppButton><AppButton loading>{t('Saving changes')}</AppButton><AppButton disabled>{t('Disabled')}</AppButton><AppButton appearance="primary" disabled>{t('Primary disabled')}</AppButton><AppIconButton ariaLabel={t('More actions')} icon={<MoreHorizontal />} /><AppTooltip content={t('More actions')}><AppIconButton ariaLabel={t('More actions with tooltip')} appearance="subtle" icon={<MoreHorizontal />} /></AppTooltip></DemoPreview></DemoSection>
