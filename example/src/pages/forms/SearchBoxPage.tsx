...
import { AppCheckBox, AppSearchBox } from '../../../../src'
...
export function AppSearchBoxPage() {
  ...
  return <DemoPage>
    ...
    <DemoSection title="Search input" description="Value changes stay immediate while explicit and debounced search wait for IME composition to finish.">
      <DemoPreview>
        <div style={{ display: 'grid', gap: 12, maxWidth: 420 }}>
          <AppSearchBox onSearch={(value) => setSubmitted(value || 'None')} onValueChange={setQuery} placeholder={t('Search documents')} size={size} value={query} />
    ...
    <DemoSection title="Debounced search">
      <DemoPreview>
        <AppSearchBox debounceMs={350} onSearch={setSubmitted} placeholder={t('Search as you type')} size={size} />
      </DemoPreview>
    </DemoSection>
  </DemoPage>
}
